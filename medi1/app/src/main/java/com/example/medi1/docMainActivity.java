...
public class docMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.docactivity_main);
        ...
        drawer = findViewById(R.id.docdrawer_layout);
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.docfragment_container,
                    new docproFragment()).commit();
            navigationView.setCheckedItem(R.id.docnav_account);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            //finish
            case R.id.docnav_account:
                getSupportFragmentManager().beginTransaction().replace(R.id.docfragment_container,
                        new docproFragment()).commit();
                break;
            //finish
            case R.id.docnav_newapts:
                getSupportFragmentManager().beginTransaction().replace(R.id.docfragment_container,
                        new docncfragment()).commit();
                break;

            case R.id.docnav_apts:
                getSupportFragmentManager().beginTransaction().replace(R.id.docfragment_container,
                        new doccapts()).commit();
                break;
                //finish
            case R.id.docnav_ttd:
                getSupportFragmentManager().beginTransaction().replace(R.id.docfragment_container,
                        new doctreaated()).commit();
                break;
            case R.id.docnav_logout:
