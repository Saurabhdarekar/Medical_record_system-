...
public class doctor_login extends AppCompatActivity {
    ...
    public void doctor_login_send(View view)
    {
        //final TextView textView = (TextView) findViewById(R.id.text);
        final Intent a = new Intent(this, docMainActivity.class);
        /* startActivity(a); */


        EditText b=findViewById(R.id.editText7);
        EditText c=findViewById(R.id.editText9);
        ...
        global g = new global();
        String url ="http://" + g.ip + "/doctor_login";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            {
                                Toast.makeText(doctor_login.this,z + " " ,Toast.LENGTH_SHORT).show();
                            }
