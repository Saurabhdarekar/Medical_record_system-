...
public class lab_report_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lab_report_list);

        a=findViewById(R.id.patient_lab_report_list);
        final ArrayList<String> b=new ArrayList<>();

        final  ArrayList<lab_appointment_information> lab_appointment_info=new ArrayList<>();

        global g = new global();
        String url ="http://" + g.ip + "/lab_reports";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                           ...
                           /* Myadapter_lab abc=new Myadapter_lab(lab_report_list.this,R.layout.lab_appointment_info,lab_appointment_info);
                            ...
                            ArrayAdapter c=new ArrayAdapter(lab_report_list.this, android.R.layout.simple_list_item_1,b);
                            a.setAdapter(c);
    ...
    {
        final Intent a=new Intent(lab_report_list.this,lab_report_display.class);
        a.putExtra("id", q);
        startActivity(a);
    }
